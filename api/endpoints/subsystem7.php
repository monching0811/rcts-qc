...
$mock_properties = [
    ...
    'b529bf30-50bf-43ab-a314-cc4c2f79c3f5' => [
        ...
        [
            ...
            'qcitizen_id' => 'b529bf30-50bf-43ab-a314-cc4c2f79c3f5',
            'property_owner' => 'Vince Nico Escala',
            'property_address' => '102 Commonwealth Avenue, Quezon City',
            'property_type' => 'Residential',
            'lot_area' => 250.00,
            'floor_area' => 180.00,
            ...
            'gis_coordinate_lat' => 14.6770,
            'gis_coordinate_lng' => 121.0440,
            'status' => 'Active',
            'annual_rpt_due' => 10000,
            'annual_sef_due' => 5000,
            'total_annual_tax' => 15000,
            'tax_clearance_status' => 'Pending',
            'assessed_value_update_flag' => false
        ],
        [
            ...
            'qcitizen_id' => 'b529bf30-50bf-43ab-a314-cc4c2f79c3f5',
            'property_owner' => 'Vince Nico Escala',
            'property_address' => '103 Katipunan Avenue, Quezon City',
            ...
            'status' => 'Active',
            'annual_rpt_due' => 20000,
            'annual_sef_due' => 10000,
            'total_annual_tax' => 30000,
            'tax_clearance_status' => 'Pending',
            'assessed_value_update_flag' => false
        ],
        [
            ...
            'qcitizen_id' => 'b529bf30-50bf-43ab-a314-cc4c2f79c3f5',
            'property_owner' => 'Vince Nico Escala',
            'property_address' => '104 Aurora Boulevard, Quezon City',
            'property_type' => 'Residential',
            'lot_area' => 180.00,
            'floor_area' => 150.00,
        ...
        [
            ...
            'qcitizen_id' => 'b529bf30-50bf-43ab-a314-cc4c2f79c3f5',
            'property_owner' => 'Vince Nico Escala',
            'property_address' => '105 Timog Avenue, Quezon City',
            'property_type' => 'Commercial',
            'lot_area' => 150.00,
            'floor_area' => 250.00,
            ...
            'status' => 'Active',
            'annual_rpt_due' => 16000,
            'annual_sef_due' => 8000,
            'total_annual_tax' => 24000,
            'tax_clearance_status' => 'Pending',
            'assessed_value_update_flag' => false
        ]
    ],
